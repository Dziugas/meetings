    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('attending', 'The guest will attend the meeting'), ('not attending', 'The guest will not attend the meeting'), ('maybe', "The guest hasn't decided yet")], default='maybe', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendees', models.ManyToManyField(related_name='meetings', through='reservations.Invitation', to=settings.AUTH_USER_MODEL)),
